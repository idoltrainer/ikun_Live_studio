...
<!--			</li>-->
      ...
      <li class="nav-link-item">
        <span @click="routerPush('/video/:param')">直播</span>
      </li>
      <li class="nav-link-item">
        <span @click="routerPush('/home')">和gpt聊天</span>
      </li>
		</ul>
		<ul class="nav-user">
			<li class="nav-link-item">
				<img class="user-head"  @click="routerPush('/newsuser/personal/:id')" src="@/assets/image/default_head.jpg" />
			</li>
			<li class="nav-link-item">
			...
			<li class="nav-user">
				<el-button class="contribute" type="danger" @click="routerPush('/video_upload')">投稿</el-button>
			</li>
		</ul>
	</div>
</template>
